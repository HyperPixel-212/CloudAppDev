...
class ShopItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shop_item" do
    assert_difference("ShopItem.count") do
      post shop_items_url, params: { shop_item: { amount: @shop_item.amount, description: @shop_item.description, name: @shop_item.name, price: @shop_item.price } }
    end
  ...
  test "should update shop_item" do
    patch shop_item_url(@shop_item), params: { shop_item: { amount: @shop_item.amount, description: @shop_item.description, name: @shop_item.name, price: @shop_item.price } }
