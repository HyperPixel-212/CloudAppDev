...
class GamesTest < ApplicationSystemTestCase
  ...
  test "search with ransack" do
    get game_url+ "?q[name_cont]=Balatro&commit=Search"
  end

  test "search with ransack" do
    get game_url+ "?q[name_cont]=The+Binding+of+Isaac&commit=Search"
  end

  test "search with ransack" do
    get game_url+ "?q[name_cont]=Terraria&commit=Search"
  end
end
